 ...
 * @author Emil Ivov
 */
public class MessageDeliveryPendingEvent
    extends MessageEvent
{
    ...
    private boolean isMessageEncrypted = false;
      ...
      */
     public MessageDeliveryPendingEvent(Message source, Contact to)
     {
      ...
      * ocurred
      */
     public MessageDeliveryPendingEvent(Message source, Contact to, Date timestamp)
     {
         super(source);
      ...
      * ocurred
      */
     public MessageDeliveryPendingEvent(
